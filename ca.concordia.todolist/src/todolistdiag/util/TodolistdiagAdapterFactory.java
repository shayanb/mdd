...
public class TodolistdiagAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected TodolistdiagSwitch<Adapter> modelSwitch =
		new TodolistdiagSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseTasksManager(TasksManager object) {
				return createTasksManagerAdapter();
			}
			@Override
			public Adapter caseFoldersManager(FoldersManager object) {
				return createFoldersManagerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link todolistdiag.TasksManager <em>Tasks Manager</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTasksManagerAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link todolistdiag.FoldersManager <em>Folders Manager</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createFoldersManagerAdapter() {
		return null;
	}
